...
Carstens, R., Deshpande, R., Esteve, P., Fidelibus, N., Neven, S. L., Ottow, R., Lokamruth, K. R., Rodríguez-Sánchez, P., Santagata, L., Buldú, J. M., Klein, B., & Torricelli, M. (2025). "[Harder, shorter, sharper, forward: A comparison of women's and men's elite football gameplay (2020-2025)](https://arxiv.org/abs/2506.22119)". arXiv preprint arXiv:2506.22119.
...
Arsenal vs Liverpool, seen through the lens of network science: each zone of the pitch is a node, each pass a connection — revealing how teams really move the ball. You can recreate a figure in this style using [`this code`](./figures/figure1_code.py).
